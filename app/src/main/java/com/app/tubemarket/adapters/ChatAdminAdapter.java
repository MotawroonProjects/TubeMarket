...
import com.app.tubemarket.databinding.ChatImageLeftAdminRowBinding;
import com.app.tubemarket.databinding.ChatImageRightAdminRowBinding;
import com.app.tubemarket.databinding.ChatMessageLeftAdminRowBinding;
import com.app.tubemarket.databinding.ChatMessageRightAdminRowBinding;
...
public class ChatAdminAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    ...
    public void onBindViewHolder(@NonNull RecyclerView.ViewHolder holder, int position) {
        ...
        if (holder instanceof HolderMsgLeft) {
            ...
            Picasso.get().load(model.getImage()).into(holderImageLeft.binding.imageChat);
            ...
            Picasso.get().load(Uri.parse(model.getImage())).into(holderImageRight.binding.image);
