...
public class MyVideosModel implements Serializable {
    ...
    private UserOperationModel user_operations_fk;
    ...
    public UserOperationModel getUser_operations_fk() {
        return user_operations_fk;
    }

    public static class UserOperationModel implements Serializable{
        private String id;
