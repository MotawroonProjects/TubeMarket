...
public class UserMessageModel extends StatusResponse implements Serializable {
    private String id;
    private String user_id;
    private String user_buy_message_id;
    private Data buy_message;
    ...
    public String getUser_buy_message_id() {
        return user_buy_message_id;
    }

    public Data getBuy_message() {
        return buy_message;
    }
